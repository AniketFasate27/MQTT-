...
// WiFi
const char* ssid = "Anya";                 // Your personal network SSID
const char* wifi_password = "123456789"; // Your personal network password

// MQTT
const char* mqtt_server = "192.168.137.101";  // IP of the MQTT broker
const char* humidity_topic = "home/livingroom/humidity";
const char* temperature_topic = "home/livingroom/temperature";
const char* mqtt_username = "aniket"; // MQTT username
const char* mqtt_password = "aniket"; // MQTT password
const char* clientID = "client_livingroom"; // MQTT client ID
//const char* clientID = "aniket"; // MQTT client ID
